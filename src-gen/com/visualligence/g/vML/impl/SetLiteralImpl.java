 ...
 * <ul>
 *   <li>{@link com.visualligence.g.vML.impl.SetLiteralImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SetLiteralImpl extends RValueImpl implements SetLiteral
{
  /**
  ...
  {
    return VMLPackage.Literals.SET_LITERAL;
  }
  ...
  public EList<LiteralExpression> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<LiteralExpression>(LiteralExpression.class, this, VMLPackage.SET_LITERAL__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case VMLPackage.SET_LITERAL__ITEMS:

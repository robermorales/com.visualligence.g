 ...
 * <ul>
 *   <li>{@link com.visualligence.g.vML.impl.TypeDeclImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeDeclImpl extends MinimalEObjectImpl.Container implements TypeDecl {
	...
	protected EClass eStaticClass() {
		return VMLPackage.Literals.TYPE_DECL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VMLPackage.TYPE_DECL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VMLPackage.TYPE_DECL__NAME:
				return getName();
		}

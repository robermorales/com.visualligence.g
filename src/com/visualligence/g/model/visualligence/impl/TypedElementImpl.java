 ...
 * <ul>
 *   <li>{@link com.visualligence.g.model.visualligence.impl.TypedElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypedElementImpl extends EObjectImpl implements TypedElement {
	...
	protected EClass eStaticClass() {
		return VisualligencePackage.Literals.TYPED_ELEMENT;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VisualligencePackage.TYPED_ELEMENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TypeDecl newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualligencePackage.TYPED_ELEMENT__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisualligencePackage.TYPED_ELEMENT__TYPE:

 ...
 * <ul>
 *   <li>{@link com.visualligence.g.model.visualligence.impl.ListImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListImpl extends TypeDeclImpl implements List {
	...
	protected EClass eStaticClass() {
		return VisualligencePackage.Literals.LIST;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, VisualligencePackage.LIST__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(TypeDecl newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VisualligencePackage.LIST__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case VisualligencePackage.LIST__TYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (derivedFeatureID) {
				case VisualligencePackage.LIST__TYPE: return VisualligencePackage.TYPED_ELEMENT__TYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == TypedElement.class) {
			switch (baseFeatureID) {
				case VisualligencePackage.TYPED_ELEMENT__TYPE: return VisualligencePackage.LIST__TYPE;
				default: return -1;
			}
		}
